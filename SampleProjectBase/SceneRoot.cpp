...
void SceneRoot::ChangeScene()
{
	...
	{
	default:
	case SCENE_FIREWORK:AddSubScene<SceneFirework>();
		DebugLog::Log("SceneName = SCENE_FIREWORK");
		break;
	/*case SCENE_BEZIER_CURVE:AddSubScene<SceneBezierCurve>();
		DebugLog::Log("SceneName= SCENE_BEZIER_CURVE");
		break;*/
	...
	case SCENE_SHADING:AddSubScene<SceneShading>();
		...
		break;
	case SCENE_MOVE_OBJECT:AddSubScene<SceneMoveObject>();
		DebugLog::Log("SceneName = SCENE_MOVE_OBJECT");
		break;
	case SCENE_BURST_VEC:AddSubScene<SceneBurstVector>();
		DebugLog::Log("SceneName = SCENE_BURST_VECTOR");
		break;*/
	}
}
